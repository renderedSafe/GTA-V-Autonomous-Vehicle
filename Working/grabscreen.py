...
class GrabScreen:
    def __init__(self, region=None, window_title='Game', window_handle=None):
        ...
        self.screen = WindowsScreenGrab(window_title=self.window_title, region=self.region,
    ...
    def get_frame(self):
        ...
        if self.window_handle is None:
            self.window_handle = self.screen.get_handle()
        return rgb
...
class WindowsScreenGrab:
    ...
    def _enum_handler(self, hwnd, lParam):
